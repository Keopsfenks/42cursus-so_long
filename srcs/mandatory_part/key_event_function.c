...
{
	data->mapr.y_player -= 1;
	data->mapr.step += 1;
	if (data->map[data->mapr.y_player][data->mapr.x_player] == 'C')
		data->value.c_count -= 1;
	if ((data->mapr.y_player + 1 == data->mapr.y_exit \
		&& data->mapr.x_player == data->mapr.x_exit))
	{
		data->map[data->mapr.y_player][data->mapr.x_player] = 'P';
		data->map[data->mapr.y_player + 1][data->mapr.x_player] = 'E';
	}
	else
	{
		data->map[data->mapr.y_player][data->mapr.x_player] = 'P';
		data->map[data->mapr.y_player + 1][data->mapr.x_player] = '0';
	}
	map_exit_check(data);
}
...
{
	data->mapr.x_player -= 1;
	data->mapr.step += 1;
	if (data->map[data->mapr.y_player][data->mapr.x_player] == 'C')
		data->value.c_count -= 1;
	if ((data->mapr.y_player == data->mapr.y_exit \
		&& data->mapr.x_player + 1 == data->mapr.x_exit))
	{
		data->map[data->mapr.y_player][data->mapr.x_player] = 'P';
		data->map[data->mapr.y_player][data->mapr.x_player + 1] = 'E';
	}
	else
	{
		data->map[data->mapr.y_player][data->mapr.x_player] = 'P';
		data->map[data->mapr.y_player][data->mapr.x_player + 1] = '0';
	}
	map_exit_check(data);
}
